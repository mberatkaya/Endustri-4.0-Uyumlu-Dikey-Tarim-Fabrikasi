...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--weights", type=Path, default=DEFAULT_WEIGHTS, help="Model agirligi yolu."
    )
    ...
    parser.add_argument(
        "--output", type=Path, default=None, help="Tahmini resim/video olarak kaydet."
    )
    parser.add_argument(
        "--max-frames", type=int, default=None, help="Video icin en fazla islenecek kare sayisi."
    )
